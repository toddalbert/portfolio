export const portfolioItems = {
  ...
  'magna': {
    ...
    'amway': {
      name: 'Amway',
      tech: ['Swift', 'iOS', 'AR', 'Photography', 'Mobile', 'AWS', 'Cloud', 'SQL', 'React', 'JavaScript'],
      description:
    ...
    'fiat': {
      name: 'FIAT',
      tech: ['Swift', '360', 'iOS', 'AR', 'Photography', 'Mobile', 'AWS', 'Cloud', 'SQL', 'React', 'JavaScript'],
      description:
    ...
    'barefoot': {
      name: 'Barefoot Wine',
      tech: ['Swift', '360', 'iOS', 'Photography', 'Mobile', 'AWS', 'Cloud', 'SQL', 'React', 'JavaScript'],
      description:
