      ...
      <div className='max-w-shell mx-auto px-[clamp(22px,5vw,56px)]'>
        <div className='max-w-[64ch]'>
          <span className='block mb-[18px] font-mono text-[12px] tracking-[0.16em] uppercase text-umber-soft'>
            <span className='text-clay-ink'>06</span>&nbsp;&nbsp;What I'm Writing &amp; building
          </span>
          <h2
            id='writing-h'
            className='m-0 font-newsreader font-medium text-[clamp(1.9rem,3.6vw,2.7rem)] leading-[1.08] tracking-[-0.01em] text-umber'>
            What's defensible when everyone has a model.
          </h2>
          <p className='mt-[20px] text-[1.1rem] leading-[1.6] text-umber-muted max-w-[58ch]'>
            The model isn't the moat — proximity to customer data and workflow is. I make technology bets for 
            software companies that have to compete with the labs, not pretend they won't. Getting that call 
            right is what a CTO is for.
          </p>
        </div>
