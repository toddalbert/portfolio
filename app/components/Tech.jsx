      ...
      <div className='py-8 lg:py-16 mx-auto my-auto max-w-screen-xl px-4'>
        ...
        <div className='grid grid-cols-2 gap-8 text-stone-400 sm:gap-12 md:grid-cols-3 lg:grid-cols-6'>
          <span className='flex justify-center items-center'>
            <img
              className='h-8 grayscale brightness-200 contrast-50 hover:scale-150 transition'
              alt='Next.js'
          ...
          <span className='flex justify-center items-center'>
            <img
              className='h-14 contrast-75 grayscale hover:scale-150 transition'
              alt='React Native'
          ...
          <span className='flex justify-center items-center'>
            <img
              className='h-14 brightness-75 grayscale hover:scale-150 transition'
              alt='React'
              src='/tech/react.svg'
            />
          </span>
          ...
          <span className='flex justify-center items-center'>
            <img
              className='h-12 grayscale invert brightness-200 contrast-50 hover:scale-150 transition'
              alt='Express'
          ...
          <span className='flex justify-center items-center'>
            <img
              className='h-12 grayscale brightness-150 contrast-50 hover:scale-150 transition'
              alt='Unity'
              src='/tech/unity.png'
            />
          </span>
          ...
          <span className='flex justify-center items-center'>
            <img
              className='h-12 grayscale brightness-150 contrast-75 hover:scale-150 transition'
              alt='Mongo DB'
          ...
          <span className='flex justify-center items-center'>
            <img
              className='h-12 grayscale brightness-100 contrast-75 hover:scale-150 transition'
              alt='Firestore'
          ...
          <span className='flex justify-center items-center'>
            <img
              className='h-12 grayscale brightness-200 contrast-75 hover:scale-150 transition'
              alt='Terraform'
