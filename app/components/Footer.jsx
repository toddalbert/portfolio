      ...
      <div className='container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col'>
        ...
        <p className='text-sm text-zinc-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-zinc-200 sm:py-2 sm:mt-0 mt-4'>
          ...
          <a
            ...
            className='text-zinc-600 transition hover:text-zinc-400 ml-1'
        ...
        <span className='inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start'>
          <a className='text-zinc-500 transition hover:text-zinc-400'>
            <svg
              fill='currentColor'
              strokeLinecap='round'
          ...
          <a className='ml-3 text-zinc-500 transition hover:text-zinc-400'>
            <svg
              fill='currentColor'
              strokeLinecap='round'
              strokeLinejoin='round'
